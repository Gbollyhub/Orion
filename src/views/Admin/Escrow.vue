<template>
  ...
  <div style="font-weight:700; font-size:15px;">Escrow</div>
        ...
        <v-card flat style="padding:30px 0;background:#F2F2F2;">
                        ...
                        <v-row class="table-header" no-gutters>
                            <v-col style="height:40px" cols="10">
                             <div style="line-height:40px;">Escrow List</div>
                            </v-col>
					...
					<tbody>
						<tr @click="toEscrow" v-for="(item,index) in 5" :key="index" >
							<td>1</td>
							<td>Sage 45</td>
							<td>Lagos</td>
							<td>20</td>
...
export default {
    ...
    data() {
     ...
     methods:{
        toEscrow(){
            this.$router.push({path:'/admin/escrow-view'})
        }
    }
}
</script>
